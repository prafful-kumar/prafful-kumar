<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Courier+Prime&weight=600&size=28&duration=3000&pause=1000&color=0077B5&center=true&width=600&lines=Prafful+Kumar+Khoba;PhD+in+Computer+Science;Vision-Language+Models+%26+Deep+Learning" alt="Typing SVG" />
</div>
...
<table align="center">
  <tr>
    <td>
      <h3>🎓 About</h3>
      <p><strong>PhD Researcher</strong> at IIT Delhi (UQIDAR joint program with University of Queensland)</p>
      <p>Specializing in:</p>
      <ul>
...
<div>
  <table>
    ...
    <tr>
      ...
      <td><strong>MoE-LLaVA</strong> – Fisher Linear Discriminant initialization of MoE routers with entropy regularization for multimodal learning</td>
    </tr>
    <tr>
...
<table>
  <tr>
    <td width="20%" align="center"><strong>Conference</strong></td>
    <td width="60%"><strong>Title & Links</strong></td>
...
![HuggingFace](https://img.shields.io/badge/HuggingFace-FFD700?logo=huggingface&logoColor=black&style=for-the-badge)
